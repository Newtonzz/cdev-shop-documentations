...
-- Keybind to sit/lie down and to stand up
Config.Control = 'e'
-- Are you using an emote resource like dpemotes? If so, add in the keybind you have set to cancel emotes here
Config.EmoteCancel = "x"
-- Keybind to change anim while sat/laying (defaulted to right arrow)
Config.ControlRight = 'RIGHT'
-- Keybind to change anim while sat/laying (defaulted to left arrow)
Config.ControlLeft = 'LEFT'
